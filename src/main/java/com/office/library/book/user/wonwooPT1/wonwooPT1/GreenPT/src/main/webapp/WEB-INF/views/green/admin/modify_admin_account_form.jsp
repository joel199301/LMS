					...
					<section>
						...
						<div class="d-flex justify-content-center">
							...
							<div class="create_account_form">
								...
								<form action="<c:url value='/admin/modifyAdmin' />"
									name="modify_admin_account_form" method="post"
									enctype="multipart/form-data">

									<input type="hidden" name="g_m_no"
										value="${loginedAdminVo.g_m_no}"> 
									<input type="hidden" name="g_m_mail" value="${loginedAdminVo.g_m_mail}">
				

									<div class="mb-3 w-100">
										<input type="email" class="form-control"
											d="exampleFormControlInput1" name="g_m_mail"
											value="${loginedAdminVo.g_m_mail}" readonly disabled>
									</div>

									<div class="mb-3 w-100">
										<input type="password" class="form-control" name="g_m_pw"
											d="exampleFormControlInput1" value="${loginedAdminVo.g_m_pw}"
									...
									<div class="mb-3 w-100">
										<input type="password" class="form-control"
											...
											value="${loginedAdminVo.g_m_pw}" placeholder="비밀번호를 재입력하세요..">
									</div>

									<div class="mb-3 w-100">
										<input type="text" class="form-control"
											d="exampleFormControlInput1" name="g_m_name"
											value="${loginedAdminVo.g_m_name}" placeholder="사용하실 닉네임을입력해주세요.." >
									</div>
									...
									<div class="mb-3 w-100">
										...
										<input type="text" class="form-control"
											...
											value="${loginedAdminVo.g_m_phone}"
									...
									<input
										type="submit" class='btn btn-secondary' value="완료"> <input
